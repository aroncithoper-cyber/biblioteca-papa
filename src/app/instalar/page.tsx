        ...
        <div className="bg-white rounded-[3rem] p-8 sm:p-12 shadow-2xl shadow-amber-900/5 border border-amber-50 text-left relative overflow-hidden">
          ...
          <div className="space-y-10 relative z-10">
            <div className="flex gap-5 items-start">
              ...
              <div>
                <p className="text-sm font-bold text-gray-900 mb-1">{t.install.step1Title}</p>
                <p className="text-xs text-gray-500 leading-relaxed">{t.install.step1Text}</p>
              </div>
            </div>
            ...
            <div className="flex gap-5 items-start">
              ...
              <div>
                <p className="text-sm font-bold text-gray-900 mb-1">{t.install.step2Title}</p>
                <p className="text-xs text-gray-500 leading-relaxed">{t.install.step2Text}</p>
              </div>
            </div>
          </div>
