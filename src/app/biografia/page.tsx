...
export default function BibliotecaPage() {
  ...
  const handleEnableNotifications = async () => {
    ...
    if (permission === "granted") {
      alert("✅ ¡Notificaciones activadas!\nTe avisaremos cuando subamos nuevos libros.");
      // Aquí el Service Worker ya se encarga del resto
    } else if (permission === "denied") {
      alert("⚠️ Las notificaciones están bloqueadas. Ve a la configuración de tu navegador para permitirlas.");
    }
  };
